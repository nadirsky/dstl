...
def convert_masks_to_polygons(MASKS, GS, classid):
    ...
    for ImageId in sorted(MASKS.keys()):
        ...
        # mask = remove_small_objects(mask.astype(bool), min_size=3).astype(np.uint8)
...
MASKS = read_masks('/mnt/ml-team/satellites/max.sokolowski/satellites/maksymilian.sokolowski@codilime.com/miscSatellites/201702281016/0/jobs/d3862e05-41e2-40a4-bcf1-4d46c74b5642/src/predictions.h5')
...
save_submit('/home/maksymilian/Desktop/submit201702281016_10Small_1.csv',submit,order)
